...
<body>
	<div class="container">
		<h3 class="fw-bold">나의 정보 수정</h3><hr>
		<form id="sendSmsForm">
				...
				<ul>
					<li>
						<div class="row-item align-middle">
							<label><img src="/resources/img/id.png"></label>
							<span>${Member.memberId}</span>
						</div>
					</li>
					<li>
						<div class="row-item">
							<label><img src="/resources/img/user.png"></label>
							<span>${Member.memberName}</span>
						</div>
					</li>
					<li>
						<div class="row-item">
							<label><img src="/resources/img/password.png"></label>
							<span>비밀번호</span>
							<button type="button" class="button" data-bs-toggle="modal" data-bs-target="#pwdModal">수정</button>
						</div>
					</li>
					<li>
						<div class="row-item">
							<label><img src="/resources/img/phone.png"></label>
							<span>${Member.memberPhone}</span>
							<button type="button" class="button" data-bs-toggle="modal" data-bs-target="#phoneModal">수정</button>
						</div>
					</li>
					<li>
						<div class="row-item">
							<label><img src="/resources/img/email.png"></label>
							<span>${Member.memberEmail}</span>
							<button type="button" class="button" data-bs-toggle="modal" data-bs-target="#emailModal">수정</button>
						</div>
					</li>
					<li>
						<div class="row-item">
							<label><img src="/resources/img/address.png"></label>
							<span>${Member.memberAddr2} &nbsp;${Member.memberAddr3}&nbsp;(${Member.memberAddr1})</span>
							<button type="button" class="button" data-bs-toggle="modal" data-bs-target="#addrModal">수정</button>
						</div>
					</li>
				</ul>
			</form>
	...
	<%-- ===================== 모달창 - 비밀번호 ===================== --%>
	<div class="modal fade" id="pwdModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title fw-bold" id="exampleModalToggleLabel"><img src="/resources/img/mickeymouse.png">비밀번호 수정</h5>
				...
				<div class="modal-body">
					<form id="f_updateForm" name="f_updateForm" method="post">
				        ...
				        <div>
				        	<input type="password" id="memberPasswd" name="memberPasswd" placeholder="현재 비밀번호" class="modal-input"/>
				            <br><span id="pwdChkSpan"></span>
				            <input type="password" id="new_password" name="new_password" placeholder="새 비밀번호" class="modal-input"/>
				            <input type="password" id="chk_password" name="chk_password" placeholder="새 비밀번호 확인" class="modal-input"/>
	...
	<div class="modal fade" id="phoneModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title fw-bold" id="exampleModalToggleLabel"><img src="/resources/img/mickeymouse.png">전화번호 수정</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<strong class="fs-5">${Member.memberName}</strong>님의 회원정보 중 <span class="modal-span">전화번호</span>를 수정하기 위해 인증절차가 필요합니다.
					<hr color="black">
					<form id="updatePhoneForm">
						<input type="hidden" id="memberId" name="memberId" value="${Member.memberId}">
						<p><img src="/resources/img/phone.png">${Member.memberPhone}</p>
						<div>
							
						</div>
						<input type="text" id="memberPhone" name="memberPhone" placeholder="전화번호" class="modal-input">
						<button type="button" id="sendSmsBtn" class="modal-button">인증번호 보내기</button>
						<input type="text" id="veriNum" placeholder="인증번호 입력" class="modal-input">
	...
	<div class="modal fade" id="emailModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title fw-bold" id="exampleModalToggleLabel"><img src="/resources/img/mickeymouse.png">이메일 수정</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<strong class="fs-5">${Member.memberName}</strong>님의 회원정보 중 <span class="modal-span">이메일</span>을 수정하기 위해 인증절차가 필요합니다.
					<hr>
					<form id="updateEmailForm">
						<input type="hidden" id="memberId" name="memberId" value="${Member.memberId}">
						<p><img src="/resources/img/email.png">${Member.memberEmail}</p>
						<input type="text" id="memberEmail" name="memberEmail" placeholder="이메일" class="modal-input">
						<button type="button" id="emailtestBtn" class="modal-button">인증번호 보내기</button>
						<input type="text" id="emailtest" name="emailtest" placeholder="인증번호 입력" class="modal-input"/> 
	...
	<div class="modal fade" id="addrModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title fw-bold" id="exampleModalToggleLabel"><img src="/resources/img/mickeymouse.png">주소 수정</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form id="updateAddrForm">
						<input type="hidden" id="memberId" name="memberId" value="${Member.memberId}">
						<p><img src="/resources/img/address.png">${Member.memberAddr2} &nbsp;${Member.memberAddr3}&nbsp;(${Member.memberAddr1})</p>
						<input class="selectAddress" value="F" type="hidden"> 
						<input type="text" readonly="readonly" id="memberAddr1" name="memberAddr1" placeholder="우편번호" class="modal-input"/>
						<button type="button" id="findAddrBtn" class="modal-button">주소 찾기</button>
						<br>
						<input type="text" readonly="readonly" id="memberAddr2" name="memberAddr2" placeholder="주소" class="modal-input"/> 
						<input type="text" readonly="readonly" id="memberAddr3" name="memberAddr3" placeholder="상세주소" class="modal-input"/>
					</form>
				</div>
				<div class="modal-footer">
