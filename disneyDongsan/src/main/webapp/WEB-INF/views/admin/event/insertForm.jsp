				                    ...
				                    <table class="table table-bordered">
				                        ...
				                        <tbody>
				                            <tr>
				                                ...
				                                <td class="text-left"><input type="text" id="e_title" name="e_title" class="form-control" placeholder="이벤트 제목 입력"/></td>
				                            </tr>
				                            <tr>
				                            ...
				                            <tr>
				                                ...
				                                <td class="text-left"><textarea rows="10" cols="22" id="e_content" name="e_content" class="form-control" placeholder="이벤트 내용 입력"></textarea></td>
				                            </tr>
