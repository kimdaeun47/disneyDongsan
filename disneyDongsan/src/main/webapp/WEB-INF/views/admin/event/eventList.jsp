                        ...
                        <c:when test="${not empty eventList }">
                            <c:forEach var="event" items="${eventList }" varStatus="status">
                                <tr class="text-center" data-num="${event.e_no }">
                                    ...
                                    <td class="day">${event.e_end }</td>
                                    <td class="text-center">${event.e_time }</td>
                                </tr>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#insertBtn").click(function(){
                location.href="/admin/event/insertForm";
            });
            
            $(".select-all-checkbox").click(function(){
            	var chk = $(".select-all-checkbox").prop("checked");
            	if(chk) {
            ...
            $(".goDetail").click(function(){
            	let e_no = $(this).closest("tr").data("num");
        ...
        function deleteSelectedItems() {
            ...
            if (confirm("영구적으로 삭제됩니다. 정말로 삭제하시겠습니까?")) {
                var url = "/admin/event/allEventDelete";
                $.ajax({
                    url: url,
                    type: 'post',
                    traditional: true,
        ...
        function deleteValue() {
           let url = "/admin/event/allEventDelete";
